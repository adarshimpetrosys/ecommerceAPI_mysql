...
const productMediaRepo = require("../DbRepository/productMediaRepo");
...
// -------------------------------------------------------------------
  ...
  async add(req, res) {
   ...
   const data = await productMediaRepo.add(req.body,filePath);
 ...
 if (data) {
  ...
  const allData = await productMediaRepo.index();
  ...
  async delete(req, res) {
    const id   = req.params.id;
    const data = await productMediaRepo.delete(id);
    // console.log(data)
    if (data) {
