...
const categoryRepo  = require("../DbRepository/categoryRepo");
...
// -------------------------------------------------------------------
  ...
  async add(req, res) {
   ...
   const data = await categoryRepo.add(req.body,filePath);
  ...
  async index(req, res) {
    const allData = await categoryRepo.index();
  ...
  async edit(req, res) {
    ...
    const data =  await categoryRepo.edit(id);
    if (data) {
  ...
  async update(req, res) {
    ...
    handleMultipartData(req, res, async (err) => {
      ...
      const updateData = await  categoryRepo.update(req.body,filePath)
      if (updateData) {
  ...
  async delete(req, res) {
    const id   = req.params.id;
    const data = await categoryRepo.delete(id);
    // console.log(data)
    if (data) {
